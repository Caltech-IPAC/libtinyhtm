...
{
    printf("%1$s [options] <level> circle <ra> <dec> <radius>\n"
           "\n"
           "%1$s [options] <level> ellipse <ra> <dec> <axis1> <axis2> <angle>\n"
           "\n"
           "%1$s [options] <level> hull <ra_1> <dec_1> <ra_2> <dec_2> ...<ra_n> <dec_n>\n"
           "\n"
           ...
           "--max-ranges | -m <max>  :  Output HTM ID ranges instead of individual IDs,\n"
           "                            limiting output to at most <max> ranges by\n"
           "                            coarsening the effective subdivision level if\n"
           "                            necessary.\n"
           "--ranges     | -r        :  Output HTM ID ranges instead of individual IDs.\n",
           prog);
}
